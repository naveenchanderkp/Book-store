  ...
  return (
    <form onSubmit={handleLogin}>
      <div className="bg-white px-6 py-6 border-2 border-gary-100 rounded-3xl">
        {/* <h1 className="text-4xl font-semibold">"Login and continue <br/>your journey with us."</h1> */}
        ...
        <div className="mt-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.email && <span className="text-red-500 text-sm mt-1 absolute block">{errors.email}</span>}
          </div>
          <div className="relative mt-6">
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.password && <span className="text-red-500 text-sm mt-1 absolute block">{errors.password}</span>}
          </div>
          <div>
          ...
          <div className="mt-6 flex items-center justify-center">
            ...
            <Link
              to="/signup"
              className="ml-2 font-medium text-base text-blue-400"
            >
              Signup
            </Link>
          </div>
